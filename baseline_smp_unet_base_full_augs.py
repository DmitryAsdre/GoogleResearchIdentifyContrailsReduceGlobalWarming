...
class CFG:
    exp_name = 'baseline_resnest26d_full_augs'
...
if __name__ == '__main__':    
    ...
    model = smp.UnetPlusPlus(encoder_name=CFG.backbone, decoder_attention_type=CFG.decoder_attention_type, decoder_use_batchnorm=True).to(CFG.device)
    ...
    for i in range(CFG.n_epoch):
        ...
        if CFG.write_to_tensorboard:
            writer.add_scalar('Train DICE', 1. - loss_train, i)
