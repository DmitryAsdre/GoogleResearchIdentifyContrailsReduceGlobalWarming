...
class CFG:
    exp_name = 'mmseg_swin_base_softmax'
...
def load_model():
    cfg = Config.fromfile("./mmsegmentation/configs/swin/swin-small-patch4-window7-in1k-pre_upernet_8xb2-160k_ade20k-512x512.py")
    cfg.model.decode_head.num_classes = 1

    model = init_model(cfg, device='cpu')
    
    state_dict = torch.load('./swin_small.pth', map_location='cpu')
